export default function ContactSection() {
  return (
    <section id="contact" className="py-24 bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-20 right-20 w-48 h-48 gradient-aurora rounded-full opacity-10 animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 gradient-sunset rounded-full opacity-5 animate-float" style={{ animationDelay: '4s' }}></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20 animate-fade-in-up">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold mb-6 leading-tight">
            Ready to Power Your
            <span className="block text-gradient-sunset mt-2">Next Project?</span>
          </h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                         Get a free consultation and personalized quote. We&apos;re available 24/7 for emergency services.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          ...
          <div className="card-glass p-8 hover-lift group cursor-pointer animate-slide-in-left">
            <div className="text-center">
              ...
              <a href="tel:1234567890" className="text-xl font-bold text-blue-400 hover:text-blue-300 transition-colors">
                +1 (234) 567-890
              </a>
            </div>
          </div>
          ...
          {/* Email Card */}
          <div className="card-glass p-8 hover-lift group cursor-pointer animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <div className="text-center">
              ...
              <a href="mailto:alex@alexelectric.com" className="text-xl font-bold text-orange-400 hover:text-orange-300 transition-colors break-all">
          ...
          {/* WhatsApp Card */}
          <div className="card-glass p-8 hover-lift group cursor-pointer animate-slide-in-right" style={{ animationDelay: '0.4s' }}>
            <div className="text-center">
              ...
              <a href="https://wa.me/1234567890" className="text-xl font-bold text-green-400 hover:text-green-300 transition-colors">
                Start Chat
              </a>
            </div>
          </div>
