  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-40 right-32 w-24 h-24 gradient-sunset rounded-full opacity-30 animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute bottom-32 left-32 w-40 h-40 gradient-aurora rounded-full opacity-25 animate-float" style={{ animationDelay: '4s' }}></div>
        <div className="absolute bottom-20 right-20 w-20 h-20 gradient-primary rounded-full opacity-35 animate-float" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in-up">
          ...
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
            <span className="block text-white mb-2">Powering the</span>
            <span className="block text-gradient-sunset text-responsive-xl">Future of</span>
            <span className="block text-white">Electricity</span>
          </h1>
          ...
          <div className="glass rounded-2xl p-6 mb-8 mx-auto max-w-3xl">
            ...
            <p className="text-lg sm:text-xl text-white/90 leading-relaxed">
              From smart homes to industrial power systems, we deliver cutting-edge electrical solutions that light up your world.
            </p>
          </div>
