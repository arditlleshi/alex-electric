...
export const metadata: Metadata = {
  ...
  description:
    "Shihni faqet e sherbimeve elektrike per Tirane dhe Durres: urgjenca, riparime, instalime, panele diellore, karikues EV, smart home dhe faqe te dedikuara per prona e biznese.",
  alternates: {
